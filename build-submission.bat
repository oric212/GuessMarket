...
mkdir "submission-build\core" "submission-build\javafx" "submission\lib\jaxb" "submission\lib\gson" "submission\lib\javafx" "submission\lib\javafx-bin"
...
"%JAVAC%" -cp "submission-build\core;%JAXB_HOME%\mod\*;%JAVAFX_SDK%\lib\*;.deps\gson-2.14.0.jar" -d "submission-build\javafx" @"submission-build\javafx-sources.txt"
if errorlevel 1 exit /b 1
...
copy /y ".deps\gson-2.14.0.jar" "submission\lib\gson\" >nul
